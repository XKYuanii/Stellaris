...
public class PayDto implements Serializable {
    ...
    @Schema(name ="channel", type ="String", description ="支付渠道 alipay：支付宝 mock：模拟支付",requiredMode= RequiredMode.REQUIRED)
    @NotNull
    private String channel;

    @Schema(name ="simulationOutcome", type ="String", description ="模拟支付结果 SUCCESS/FAILURE；仅 mock 渠道使用")
    private String simulationOutcome;
