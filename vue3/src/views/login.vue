  ...
  <div class="app-container">
    ...
    >
      <div class="wrapper">
        ...
        <p class="experience-credential">手机号：13212345678</p>
        <p class="experience-credential">密码：123456..</p>
        <p class="experience-note">账号仅用于本地工程链路演示，请以当前初始化数据为准。</p>
    ...
    .login {
      ...
      .main-left {
        ...
        .login-hero {
          ...
          border-radius: 24px;
          background: radial-gradient(circle at 80% 10%, rgba(255, 106, 61, 0.55), transparent 35%),
          linear-gradient(135deg, #25105f, #11052d);
          color: #fff;
