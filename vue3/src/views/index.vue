<template>
  ...
  <div class="app-container">
    <section class="hero-banner">
      <div>
        <span class="hero-kicker">STELLARIS TICKETING · V5</span>
        <h1>热门演出，可靠成交</h1>
        <p>原子锁座、可靠事件、幂等消费、延迟取消与库存对账组成可恢复交易闭环。</p>
      </div>
      <div class="hero-badge">STELLARIS</div>
    </section>
    <!--    中间各类型-->
    <div class="category">
      <ul>
...
.app-container {
  ...
  .hero-banner {
    ...
    overflow: hidden;
    background: radial-gradient(circle at 78% 20%, rgba(255, 151, 115, 0.7), transparent 28%),
    linear-gradient(125deg, #2a0b55, #5d154c 55%, #ca321d);
    color: #fff;
