...
public class RsaSignTool {
    ...
    public static String rsaSign256(String content, String privateKey) {
        try {
            ...
            throw new StellarisFrameException(BaseCode.GENERATE_RSA_SIGN_ERROR);
        }
    }
     ...
     * rsa签名私钥
     * */
    public static String signPrivateKey = System.getenv("STELLARIS_DEMO_SIGN_PRIVATE_KEY");
    /**
     * rsa签名公钥
     * */
    public static String signPublicKey = System.getenv("STELLARIS_DEMO_SIGN_PUBLIC_KEY");
    /**
     * rsa数据加密私钥
     * */
    public static String dataPublicKey = System.getenv("STELLARIS_DEMO_DATA_PUBLIC_KEY");
    /**
     * rsa数据解密私钥
     * */
    public static String dataPrivateKey = System.getenv("STELLARIS_DEMO_DATA_PRIVATE_KEY");
