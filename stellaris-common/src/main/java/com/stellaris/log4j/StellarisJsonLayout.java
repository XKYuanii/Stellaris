...
public final class StellarisJsonLayout extends BaseJsonLayout {
    ...
    private StellarisJsonLayout(Configuration config, boolean locationInfo, boolean properties,
     ...
     */
    @PluginFactory
    public static StellarisJsonLayout newLayout(
        ...
        return new StellarisJsonLayout(config, locationInfo, properties, threadContextAsList,
     ...
     * 创建默认实例（用于测试）
     */
    public static StellarisJsonLayout defaultLayout() {
        return new StellarisJsonLayout(new DefaultConfiguration(), false, false, false,
