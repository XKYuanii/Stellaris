package com.stellaris.filter.impl;
...
import static com.stellaris.constant.Constant.GRAY_FLAG_FALSE;
import static com.stellaris.constant.Constant.GRAY_FLAG_TRUE;
        ...
        try {
            ...
            if (!result && grayFromRequest.equalsIgnoreCase(GRAY_FLAG_TRUE)) {
                if (CollectionUtil.isEmpty(servers)) {
                    throw new StellarisFrameException(BaseCode.SERVER_LIST_NOT_EXIST);
                }
