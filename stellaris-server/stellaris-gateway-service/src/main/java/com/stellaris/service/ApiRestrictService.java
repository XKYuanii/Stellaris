...
import com.stellaris.enums.ApiRuleType;
...
import com.stellaris.service.lua.ApiRestrictCacheOperate;
    ...
    public void apiRestrict(String id, String url, ServerHttpRequest request) {
        if (checkApiRestrict(url)) {
            ...
            if (triggerResult == 1) {
                ...
                throw new StellarisFrameException(BaseCode.API_RULE_TRIGGER.getCode(),defaultMessage);
            }
        }
    }
