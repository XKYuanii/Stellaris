...
public class GatewayDefaultExceptionHandler implements ErrorWebExceptionHandler {
    ...
    public Mono<Void> handle(ServerWebExchange exchange, Throwable ex) {
        ...
        }else if (ex instanceof StellarisFrameException) {
            StellarisFrameException StellarisFrameException = (StellarisFrameException)ex;
            ApiResponse<String> apiResponse = ApiResponse.error(StellarisFrameException.getCode(), StellarisFrameException.getMessage());
