...
public class DistributedLockConstants {
    ...
    /** 退款渠道幂等调用串行化。 */
    public final static String REFUND_PAYMENT = "d_refund_payment_lock";

    public final static String REFERENCE_RECONCILIATION = "d_reference_reconciliation_lock";

    public final static String REFERENCE_PREHEAT = "stellaris_reference_preheat_lock";

    /** v5 同一节目、账户的购票配额串行化。 */
    public final static String REFERENCE_ACCOUNT_QUOTA = "stellaris_reference_account_quota_lock";
}
