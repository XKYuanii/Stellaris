...
import com.stellaris.RedisStreamConfigProperties;
import com.stellaris.RedisStreamHandler;
import com.stellaris.RedisStreamListener;
...
public class RedisStreamAutoConfig {
    ...
    public void checkConsumerType(String consumerType){
        if ((!RedisStreamConstant.GROUP.equals(consumerType)) && (!RedisStreamConstant.BROADCAST.equals(consumerType))) {
            throw new StellarisFrameException(BaseCode.REDIS_STREAM_CONSUMER_TYPE_NOT_EXIST);
        }
    }
}
